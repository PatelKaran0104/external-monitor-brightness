...
- State is written atomically and backed up at `C:\Users\mukti\AppData\Local\BrightnessControl\state.json.bak` to reduce corruption risk.
...
- Logs are written to `C:\Users\mukti\AppData\Local\BrightnessControl\app.log`.
